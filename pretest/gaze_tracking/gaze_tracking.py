...
class GazeTracking(object):
    ...
    def learning_face(self):
        ...
        return self.eyebrow_height, self.eyebrow_pitch, self.mouth_height, self.mouth_pitch, self.eyes_pitch, self.outblinking, self.outright, self.outleft, self.outcenter
